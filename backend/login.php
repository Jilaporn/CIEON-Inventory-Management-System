...
<head>
	...
	<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="../frontend/cieonlocal/../frontend/cieonlocal/template_login/vendor/bootstrap/css/bootstrap.min.css">
	<!--===============================================================================================-->
...
<body>
    ...
    <a class="btn btn-primary display-4" href="login.php">Back</a></div>
    </div>
				...
				<div class="wrap-login100">
					...
					if (isset($_POST['submit'])) {
						...
						if ($user_id >= 1) {
							...
							$txt = "Name:" . $user_firstname . "\n Your reset password link is http://www.cieinventory.ga/backend/forgotpassword.php?token=" . $password . "\n Please using this password to login the system ";
	...
	<?php } else { ?>
		<div class="limiter">
			<div class="container row">
				<a class="btn btn-primary display-4" href="../../frontend/cieonui/index.php">Back</a>
			</div>
		</div>
		<div class="container-login100">
			<div class="wrap-login100">
				...
				if (isset($_POST['submit'])) {
					...
					if ($num >= 1) {
						...
						if ($user_position == 0) {
							...
							echo $cls_conn->goto_page(1, 'system/');
						...
						echo $cls_conn->show_message('Username or Password is incorrect If you forget your password please use forget password buttom');
						// echo $sql;
						// echo $sql2;
					}
				}
