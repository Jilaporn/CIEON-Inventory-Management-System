                             ...
                             while($row=mysqli_fetch_array($result))
                             {
                                 ?>
                                    <tr>
                                        ...
                                        <!-- <td>
                                            <a href="update_return.php?id=<?=$row['return_id'];?>" onclick="return confirm('Do you want to edit?')"><img src="../image/edit.png" /></a>
                                        </td>
                                        <td>
                                            <a href="delete_return.php?id=<?=$row['return_id'];?>" onclick="return confirm('Do you want to delete?')"><img src="../image/delete.png" /></a>
                                        </td> -->
                                    </tr>
                                    <?php
                             }
