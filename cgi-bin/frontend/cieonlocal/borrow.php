        ...
        <div class="container">
            ...
            <div class="row mt-4" id="myItems">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    //          FROM
                    //          tb_cate_item
                    //          INNER JOIN tb_item_detail ON tb_cate_item.item_id = tb_item_detail.item_id 
                    //          $count =  count(tb_item_detail.itd_item_name)   
                    //          where  tb_item_detail.itd_cate_type = '$type' and tb_cate_item.ith_avalible > '0' and $count > '0'
                ...
                ?>
                    <div class="item features-image сol-12 col-md-6 col-lg-4">
                        <div class="item-wrapper item-content">
                            <div class="item-img">
