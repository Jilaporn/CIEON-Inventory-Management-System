                ...
                <div class="row align-items-center">
                    <div class="col-12 col-lg">
                        <div class="text-wrapper">
                            <h6 class="card-title mbr-fonts-style display-2"><strong>Broken</strong></h6>
                            <p class="mbr-text mbr-fonts-style mb-4 display-4">
                                The user can declare the broken item(s) by this feature. The processes are choosing the broken items then clicking submit button. After submitting the user status will be penalty.</p>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-10">
                    ...
                    <p class="mbr-text align-center mbr-fonts-style my-4 display-5">
                        <em>Borrow Items List(Broken)</em>
                    </p>
                    <hr class="line">
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-wrapper">
                            ...
                            <div class="col-12 col-md">
                                <div class="card-box">
                                    <div class="row">
                                            ...
                                            <div class="card-box">
                                                <div class="row">
                                                    <div class="col-md">
                                                        ...
                                                        <a data-toggle="modal" data-target="#myModal1<?= $row['rfid_tag'] ?>" style="margin-left: 5% ;" class="btn btn-primary display-4">Broken</a>
                                        ...
                                        <div class="modal fade" style="height: 100%;" id="myModal1<?= $row['rfid_tag'] ?>" role="dialog">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Broken Detail</h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <!-- <p>Some text in the modal.</p> -->
                                                            <textarea type="text" name="bk_detail" class="form-control"></textarea>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type='submit' name='submit' class="btn btn-default">Broken</button>
                                                            <a href="index.php" class="btn btn-default">Cancel</a>
                                                            <button type='submit' name='submit' value="out" class="btn" style="background-color: red; color:white;">Logout</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $sql4 = " insert into tb_activity(user_id,rfid_tag,locker_no,item_id,act_type,user_sts,act_exp_date,act_flag,act_pic,act_boxno,act_item_name,act_bk_detail)";
                            $sql4 .= " values ('$idd','$tag','$locker','$item','bk','p','-','o','$pic','$boxno','$item_name','$bk_detail')";
                            ...
                            if ($_POST['submit'] == 'out') {
                                ...
                                echo $cls_conn->goto_page(1, 'broken.php');
                            }
                        }
