                ...
                <div class="col-12 col-lg">
                    <div class="text-box">
                        <h5 class="mbr-title mbr-fonts-style display-2">
                            <strong>Borrow</strong></h5>
                        <p class="mbr-text mbr-fonts-style display-7">The process of borrow features begin with choosing the item(s) and amount then submit it.</p>
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-12 col-md-8">
                ...
                <?php
                    ...
                    <button type="submit" value="<?=$row['ith_cate_type'];?>" name="submit" class="nav-link bt  display-7"> <?=$row['ith_cate_type'];?></button></li>
                <?php  
                } 
?>
...
// item on page
                            if(isset($_POST['submit'])){
                             ...
                             where  tb_item_detail.itd_cate_type = '$type' 
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    ...
                    <!-- <form method="POST">
                        ...
                        <input type="number" name="num" value="0" max="<?=$product_qty?>" min ="0" class="form-control" >
                        <button type="submit" name="submitt" value="submit" class="button button2" >submit</button>
                    </form> -->
           ...
           <!-- <?php
                if (isset($_POST['submitt'])) {
                    ...
                    $sql = " insert into tb_order(category_id,user_id,order_status,order_amount)";
                    $sql .= " values ('$category_id','$user','reserve','$num')";
