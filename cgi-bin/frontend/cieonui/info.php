...
<body>
    ...
    ";
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            $itd_cate_type = $row['itd_cate_type'];
        ...
        <div class="container">
        <a onclick="window.history.back();" style="font-size: 150%;">Back</a>
                ...
                <div class="row align-items-center">
                    ...
                    <form method="post">
                        <div class="col-12 col-lg">
                            <div class="text-box">
                                ...
                                <p class="mbr-text mbr-fonts-style display-7">Type:&nbsp;<?= $itd_cate_type ?></p>
                    ...
                    if (isset($_POST['submitt'])) {
                        ...
                        $sqll8 = "SELECT
                            ...
                            where tb_reserve.user_id = '$user' and tb_reserve.item_id = '$item_id' 
                            GROUP BY tb_reserve.item_id
                            ";
                        $ree8 = $cls_conn->select_base($sqll8);
                        while ($row = mysqli_fetch_array($ree8)) {
                            $allamount = $row['sum(tb_reserve.rs_amount)'];
                        }
                        ...
                        if ($num > $ith_avalible) {
                            ...
                            $sql .= " values ('$user','$item_id','$num','$itd_cate_type','o','$item_name','$item_pic')";
                            ...
                            while ($a <= $num) {
                                ...
                                $sqlactivity2 .= " values ('$idd','$locker_no','$item_id','rs','n','$datedate','o','$item_pic','$item_name','0')";
