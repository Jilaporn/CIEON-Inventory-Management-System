...
<section class="engine"><a href="https://mobirise.info/q">free responsive site templates</a></section><section class="header15 cid-spnHkn7NcH" id="header15-o">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="mbr-figure col-12 col-md-7"><iframe width="560" height="315" 
            src="https://www.youtube.com/embed/2w9wx01CBw4?autoplay=1" title="YouTube video player" 
        ...
        <div class="row mt-4">
            <div class="item features-image сol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/reserve.jpg" alt="">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7"><strong>Reserve</strong></h5>
                        
                        <p class="mbr-text mbr-fonts-style mt-3 display-7">User can reserve the items through online. After user choose the items and submit the information. User will receive OTP via E-mail and fill that OTP on the panel in front of the locker to take the items inside the locker.</p>
                    </div>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/extend.jpg" alt="">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7"><strong>Extend Date/Time</strong></h5>
                        
                        <p class="mbr-text mbr-fonts-style mt-3 display-7">User can extend the return date of items before the deadline 1 day.</p>
                    </div>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    ...
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7"><strong>Lost</strong></h5>
                        
                        <p class="mbr-text mbr-fonts-style mt-3 display-7">User can declare the items and quantity of items that they lost through website. However, those user will receive a penalty and cannot use the system until the admin edit their penalty status.<br></p>
                    </div>
