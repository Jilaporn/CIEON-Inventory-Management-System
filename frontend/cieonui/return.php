                    ...
                    <div class="card-wrapper">
                                                ...
                                                <div class="row">
                                                    <div class="col-md">
                                                        <form method="post">
                                                            ...
                                                            <button type="submit" style="margin-left: 5% ;" name="submit" class="btn btn-primary display-4">Return</button>
                                                        </form>
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if ($act_exp_date < $d) {
                                ...
                                $sql3 .= " values ('$idd','$tag','$locker','$item','r','p','-','o','$pic','$boxno','$item_name')";
                                ...
                                $sql3 = " insert into tb_activity(user_id,rfid_tag,locker_no,item_id,act_type,user_sts,act_exp_date,act_flag,act_pic,act_boxno,act_item_name)";
                                $sql3 .= " values ('$idd','$tag','$locker','$item','r','$sts','-','o','$pic','$boxno','$item_name')";
