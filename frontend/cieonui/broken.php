...
<section class="features8 cid-spwNxYQxed" xmlns="http://www.w3.org/1999/html" id="features9-1i">
    ...
    <?php 
        ...
        FROM
        tb_activity        
        where  tb_activity.user_id = '$idd' and tb_activity.act_type ='b'
                    ...
                    <div class="col-12 col-md">
                        ...
                        <div class="col-12 col-md">
                            <div class="card-box">
                                <div class="row">
                                <div class="col-md">
                                <button type="submit" style="margin-left: 5% ;" name="submit" class="btn btn-primary display-4" >Submit</button>
