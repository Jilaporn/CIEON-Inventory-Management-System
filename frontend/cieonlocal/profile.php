    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                <form  onsubmit="return set_phone_number()" method="POST"  method="POST" class="mbr-form form-with-styler mx-auto" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="7khKMkVwbetY76hTLpQFWqCWFFM5KwUTE4MrtC8lCzfnwwXoG0nXXq59C8boaS/TlnSRXEuGbC9KyTlRoJFBdumk+jf2YXGxnjyR+Fz9Yru+IqXugOT4nXf4+f95+7Fw">
                    ...
                    <div class="dragArea row">
                        ...
                        Firstname :<input type="text" required="required" name="firstname" placeholder="Firstname" minlength="1" maxlength="25" data-form-field="name" class="form-control" value="<?=$user_firstname?>" id="name-form7-2y">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="surname">
                            Surname :<input type="text" required="required" name="surname" placeholder="Surname" minlength="1" maxlength="25" data-form-field="surname" class="form-control" value="<?=$user_surname?>" id="name-form7-2y">
                        </div>
