<?php 
    ...
    $cls_conn2=new class_conn();
    $date_now = date("Y-m-d H:i:s");
    $sql = "SELECT * FROM tb_reserve WHERE rs_flag = 'o'";
    $result = $cls_conn2->select_base($sql);
