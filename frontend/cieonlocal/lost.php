        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-10">
                ...
                <p class="mbr-text align-center mbr-fonts-style my-4 display-5">
                    <em>Borrow Items List(Broken)</em></p>
                <hr class="line">
            </div>
        </div>
    </div>
                        ...
                        <div class="card-box">
                            ...
                            <div class="col-md">
                                    <h6 class="card-title mbr-fonts-style display-5">
                                        <strong><?=$row['act_item_name']?></strong></h6>
...
<div class="modal fade" style="height: 100%;" id="myModal1<?=$row['rfid_tag']?>" role="dialog">
    ...
    if(isset($_POST['submit'])){
        ...
        $limitt = $limit + 1;
            ...
            $sql3 = " insert into tb_activity(user_id,rfid_tag,locker_no,item_id,act_type,user_sts,act_exp_date,act_flag,act_pic,act_boxno,act_item_name)";
            $sql3 .= " values ('$idd','$tag','$locker','$item','l','p','-','o','$pic','$boxno','$item_name')";
